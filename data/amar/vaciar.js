...
export default {
  ...
  inflections: {
    indicative: {
      present: {
        singular: {
          first(){ return replaceLast(this.root(), 'i', 'í') + 'o'},
          second(){ return replaceLast(this.root(), 'i', 'í') + 'as'},
          third(){ return replaceLast(this.root(), 'i', 'í') + 'a'}
        },
        plural: {
          third(){ return replaceLast(this.root(), 'i', 'í') + 'an'}
        }
      }
    },
    subjunctive: {
